  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-black via-[#140a24] to-[#220c3d] text-white">
      <div className="mx-auto flex min-h-screen w-full max-w-md flex-col px-4 py-6 sm:px-5 sm:py-8">
        ...
        <div className="mt-8">
          <h1 className="font-['Sora'] text-3xl font-semibold tracking-tight text-violet-50">
            Enter Email or Phone Number
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-violet-100/65">
            We need your email or phone number to keep records of your appeal status. Please make sure this
        ...
        <form onSubmit={handleSubmit} className="mt-7">
          <input
            ...
            className="w-full rounded-2xl border border-violet-300/25 bg-cosmic-900/70 px-4 py-3.5 text-sm text-violet-100 outline-none transition-all duration-300 placeholder:text-violet-100/40 focus:border-violet-300/80 focus:shadow-[0_0_0_3px_rgba(168,85,247,0.25)]"
          />
